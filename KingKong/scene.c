...
void SceneInit(void)
{
    ...
    ituFtInit();
	ituFtLoadFont(0, CFG_PRIVATE_DRIVE ":/font/" "OPPOSansRL.ttf", ITU_GLYPH_8BPP); 
	ituFtLoadFont(1, CFG_PRIVATE_DRIVE ":/font/" "OPPOSansB.ttf", ITU_GLYPH_8BPP);
...
#ifdef CFG_ENABLE_ROTATE
        sprintf(filepath, CFG_PRIVATE_DRIVE ":/itu/%ux%u/ctrlboard.itu", ithLcdGetHeight(), ithLcdGetWidth());
#else
